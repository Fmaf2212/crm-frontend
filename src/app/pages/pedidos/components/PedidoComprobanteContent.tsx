...
const PedidoComprobanteContent: React.FC<PedidoComprobanteProps> = ({ data }) => {
    ...
    <View style={styles.page}>
      ...
      <View style={styles.headerRow}>
        ...
        <View style={{ alignItems: "flex-end" }}>
          ...
          <Text style={styles.headerNroPedido}>Nro Pedido: {data.id_Pedido}</Text>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.card}>
          <View style={styles.table}>
            ...
            {data.detallePedido?.length > 0 ? (
              data.detallePedido.map((prod: any, i: any) => (
              ...
              <View style={styles.tableRow}>
                <Text style={[styles.td, { textAlign: "center", color: "#6B7280" }]}>No hay productos</Text>
              </View>
            )}
          </View>
        </View>
        ...
        <View style={styles.resumenFila}>
          <Text style={styles.resumenTexto}>Subtotal: S/ {subtotal.toFixed(2)}</Text>
          ...
          <View style={styles.row}>
            <View style={{ flex: 1 }}>
              ...
              <View style={styles.rowBlockInput}>
                ...
                <Text style={styles.value}>{data.acuerdo_de_Pago || "—"}</Text>
              </View>
            </View>
      ...
      <View style={styles.footer}>
        ...
        >
          <View style={{ flexDirection: "row", alignItems: "center" }}>
            <Image src="/assets/icoWsp.png" style={{ width: 12, height: 12, marginRight: 3 }} />
...
export default PedidoComprobanteContent;
